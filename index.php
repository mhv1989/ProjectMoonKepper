...
<?php get_header(); ?>
	...
	<img src="<?php bloginfo('template_directory');?>/assets/svg/bubble6.png" class="d-none d-md-block t-2770 l-5 position-absolute w-6" />
...
?>
	    <div class="row m-10 py-5">
	        ...
	        <div class="col-sm-5 px-3 pt-5 p-sm-none">
...
<?php endif; ?>
	   ...
	   <!-- Section 3 -->
		<div class="row m-10 rtl ta-r">
			...
			<div class="col-md-6 px-5">
				<img src="<?php bloginfo('template_directory');?>/assets/svg/bitcoin-server.png" class="w-75 mx-auto d-block">
			</div>
		</div>
